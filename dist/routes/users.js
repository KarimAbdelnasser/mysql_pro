...
router.post("/signUp", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                user = _b.sent();
                return [4 /*yield*/, user.get({ plain: true })];
            case 5:
                newUser = _b.sent();
                token = (0, authToken_1.default)(newUser.id, username);
                res.status(201).send("Created new user & token= ".concat(token));
                return [3 /*break*/, 7];
            case 6:
                err_1 = _b.sent();
                console.log(err_1);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                exist = _a.sent();
                if (!exist)
                    return [2 /*return*/, res.status(400).send("User haven't registered yet!")];
